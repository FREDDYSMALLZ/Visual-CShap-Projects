...
namespace DataBaseAccess {
    ...
    public partial class dbSchoolDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public StudentRow AddStudentRow(string FirstName, string LastName) {
...
namespace DataBaseAccess.dbSchoolDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Student` WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Student` SET `FirstName` = ?, `LastName` = ? WHERE ((`ID` = ?) AND ((? = " +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataBaseAccess.Properties.Settings.Default.dbSchoolConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FirstName, LastName FROM Student";
        ...
        public virtual int Fill(dbSchoolDataSet.StudentDataTable dataTable) {
        ...
        public virtual dbSchoolDataSet.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbSchoolDataSet.StudentDataTable dataTable = new dbSchoolDataSet.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbSchoolDataSet.StudentDataTable dataTable) {
